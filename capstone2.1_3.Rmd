...
blogs.tri_tab5 <- blogs.tri_tab4.1[,gram.count:=.N, by = gram]
...
news.tri_tab5 <- news.tri_tab4.1[,gram.count:=.N, by = gram]
...
tweets.tri_tab5 <- tweets.tri_tab4.1[,gram.count:=.N, by = gram]
