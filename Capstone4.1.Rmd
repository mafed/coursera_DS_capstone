...
Next we make n-grams and separate "ngrams" from the "targets" that we will try to predict.
...
We then subsample our validation data set for a first look at accuracy scores with our base lambda values. 
